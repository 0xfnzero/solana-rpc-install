...
- **存储**: 2-3块 NVMe SSD (1TB系统盘 + 2TB账户盘 或 合并的2TB+账户/账本盘)
...
> **💡 如何选择安装方式？**
> - **Jito 预编译版本**: 安装快速，包含 MEV 支持，生产就绪。推荐大多数用户使用。
> - **源码编译**: 完全控制，自定义构建选项，适合开发者和高级用户。
> - **详细对比**: 查看 [JITO_VS_SOURCE.md](JITO_VS_SOURCE.md) 或 [英文版](JITO_VS_SOURCE_EN.md)。
